...
public class MemReqDetail extends AppCompatActivity {

    private TextView memReqDetail_patient_name,memReqDetail_blood_group;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mem_req_detail);


        memReqDetail_patient_name = (TextView) findViewById(R.id.memReqDetail_patient_name);
        memReqDetail_blood_group = (TextView) findViewById(R.id.memReqDetail_blood_group);
        btnCall = (Button) findViewById(R.id.memReqDetail_btnCall);
        ...
        memReqDetail_patient_name.setText(full_name);
        memReqDetail_blood_group.setText(blood_group);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(MemReqDetail.this, AreaMember.class);
