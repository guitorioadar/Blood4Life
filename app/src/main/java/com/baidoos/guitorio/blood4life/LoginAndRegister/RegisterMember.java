...
public class RegisterMember extends AppCompatActivity {
    ...
    //private String URL_REG_MEMBER = "http://192.168.75.1/Blood4Life/register.php";

    private String user_type="Member";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spnAdapterBloodGroup = ArrayAdapter.createFromResource(RegisterMember.this,R.array.blood_group,android.R.layout.simple_spinner_item);
        ...
        spnBloodGroup.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                if(blood_group==parent.getItemAtPosition(0))
                    Toast.makeText(RegisterMember.this, "Please Select One...", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        spnAdapterGender = ArrayAdapter.createFromResource(RegisterMember.this,R.array.gender,android.R.layout.simple_spinner_item);
        ...
        tvDateOfBirth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePickerDialogDateOfBirth = new DatePickerDialog(RegisterMember.this,
        ...
        spnAdapterCountry = ArrayAdapter.createFromResource(RegisterMember.this,R.array.Country,android.R.layout.simple_spinner_item);
        ...
        spnCountry.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(RegisterMember.this, "Please Select Country...", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        spnAdapterDivision = ArrayAdapter.createFromResource(RegisterMember.this,R.array.Divisions,android.R.layout.simple_spinner_item);
        ...
        spnDivision.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(RegisterMember.this, "Please Select Division...", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        spnAdapterDistrict = ArrayAdapter.createFromResource(RegisterMember.this,R.array.Districts,android.R.layout.simple_spinner_item);
        ...
        spnAdapterAvailableStatus = ArrayAdapter.createFromResource(RegisterMember.this,R.array.available_status,android.R.layout.simple_spinner_item);
        ...
        spnAvailableStatus.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(RegisterMember.this, "Please Select Status...", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void regGeneralPeople() {
        ...
        if(full_name.isEmpty()){
            Toast.makeText(RegisterMember.this, "Please enter your name", Toast.LENGTH_SHORT).show();
        }else if(blood_group.equals("Select Blood Group")){
            Toast.makeText(RegisterMember.this, "Please Select Blood Group", Toast.LENGTH_SHORT).show();
        }else if(gender.equals("Select Gender")){
            Toast.makeText(RegisterMember.this, "Please Select Gender", Toast.LENGTH_SHORT).show();
        }else if(date_of_birth.isEmpty()){
            Toast.makeText(RegisterMember.this, "Please Select Date of Birth", Toast.LENGTH_SHORT).show();
        }else if(contact_no.isEmpty()){
            Toast.makeText(RegisterMember.this, "Please Add Contact Number", Toast.LENGTH_SHORT).show();
        }else if(country.equals("Select Country")){
            Toast.makeText(RegisterMember.this, "Please your country...", Toast.LENGTH_SHORT).show();
        }else if(division.equals("Select Division")){
            Toast.makeText(RegisterMember.this, "Please select your division...", Toast.LENGTH_SHORT).show();
        }else if(district.equals("Select District")){
            Toast.makeText(RegisterMember.this, "Please select your district...", Toast.LENGTH_SHORT).show();
        }else if(email.isEmpty()){
            Toast.makeText(RegisterMember.this, "Invalid Email...", Toast.LENGTH_SHORT).show();
        }else if(!password.equals(confirm_password)){
            Toast.makeText(RegisterMember.this, "Password doesn't match...", Toast.LENGTH_SHORT).show();
        }else if(user_name.isEmpty()){
            Toast.makeText(RegisterMember.this, "Enter Username...", Toast.LENGTH_SHORT).show();
        }else if(available_status.equals("Select Available Status")){
            Toast.makeText(RegisterMember.this, "Please select if you are now available or not to donate blood", Toast.LENGTH_LONG).show();
        }

        else {

            StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.URL_REG_MEMBER,
                    new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
                            Toast.makeText(RegisterMember.this, response, Toast.LENGTH_SHORT).show();
                        }
                    }, new Response.ErrorListener() {
                @Override
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(RegisterMember.this, error.toString(), Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
