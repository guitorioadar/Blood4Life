...
public class RegisterGeneralPeople extends AppCompatActivity {

    //private String URL_REG_GENERAL_PEOPLE = "http://192.168.75.1/Blood4Life/register.php";

    private String user_type="General People";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spnAdapterBloodGroup = ArrayAdapter.createFromResource(RegisterGeneralPeople.this,R.array.blood_group,android.R.layout.simple_spinner_item);
        ...
        spnBloodGroup.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                if(blood_group==parent.getItemAtPosition(0))
                    Toast.makeText(RegisterGeneralPeople.this, "Please Select One...", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        spnAdapterGender = ArrayAdapter.createFromResource(RegisterGeneralPeople.this,R.array.gender,android.R.layout.simple_spinner_item);
        ...
        tvDateOfBirth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePickerDialogDateOfBirth = new DatePickerDialog(RegisterGeneralPeople.this,
        ...
        spnAdapterCountry = ArrayAdapter.createFromResource(RegisterGeneralPeople.this,R.array.Country,android.R.layout.simple_spinner_item);
        ...
        spnCountry.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(RegisterGeneralPeople.this, "Please Select Country...", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        spnAdapterDivision = ArrayAdapter.createFromResource(RegisterGeneralPeople.this,R.array.Divisions,android.R.layout.simple_spinner_item);
        ...
        spnDivision.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(RegisterGeneralPeople.this, "Please Select Division...", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        spnAdapterDistrict = ArrayAdapter.createFromResource(RegisterGeneralPeople.this,R.array.Districts,android.R.layout.simple_spinner_item);
        ...
        spnAdapterAvailableStatus = ArrayAdapter.createFromResource(RegisterGeneralPeople.this,R.array.available_status,android.R.layout.simple_spinner_item);
        ...
        spnAvailableStatus.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(RegisterGeneralPeople.this, "Please Select Status...", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void regGeneralPeople() {
        ...
        if(full_name.isEmpty()){
            Toast.makeText(RegisterGeneralPeople.this, "Please enter your name", Toast.LENGTH_SHORT).show();
        }else if(blood_group.equals("Select Blood Group")){
            Toast.makeText(RegisterGeneralPeople.this, "Please Select Blood Group", Toast.LENGTH_SHORT).show();
        }else if(gender.equals("Select Gender")){
            Toast.makeText(RegisterGeneralPeople.this, "Please Select Gender", Toast.LENGTH_SHORT).show();
        }else if(date_of_birth.isEmpty()){
            Toast.makeText(RegisterGeneralPeople.this, "Please Select Date of Birth", Toast.LENGTH_SHORT).show();
        }else if(contact_no.isEmpty()){
            Toast.makeText(RegisterGeneralPeople.this, "Please Add Contact Number", Toast.LENGTH_SHORT).show();
        }else if(country.equals("Select Country")){
            Toast.makeText(RegisterGeneralPeople.this, "Please your country...", Toast.LENGTH_SHORT).show();
        }else if(division.equals("Select Division")){
            Toast.makeText(RegisterGeneralPeople.this, "Please select your division...", Toast.LENGTH_SHORT).show();
        }else if(district.equals("Select District")){
            Toast.makeText(RegisterGeneralPeople.this, "Please select your district...", Toast.LENGTH_SHORT).show();
        }else if(email.isEmpty()){
            Toast.makeText(RegisterGeneralPeople.this, "Invalid Email...", Toast.LENGTH_SHORT).show();
        }else if(!password.equals(confirm_password)){
            Toast.makeText(RegisterGeneralPeople.this, "Password doesn't match...", Toast.LENGTH_SHORT).show();
        }else if(user_name.isEmpty()){
            Toast.makeText(RegisterGeneralPeople.this, "Enter Username...", Toast.LENGTH_SHORT).show();
        }else if(available_status.equals("Select Available Status")){
            Toast.makeText(RegisterGeneralPeople.this, "Please select if you are now available or not to donate blood", Toast.LENGTH_LONG).show();
        }

        else {

            StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.URL_REG_GENERAL_PEOPLE,
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(RegisterGeneralPeople.this, error.toString(), Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(RegisterGeneralPeople.this);
