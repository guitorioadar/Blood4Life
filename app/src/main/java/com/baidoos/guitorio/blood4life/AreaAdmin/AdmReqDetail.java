...
public class AdmReqDetail extends AppCompatActivity {

    private TextView admReqDetail_patient_name,admReqDetail_blood_group;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adm_req_detail);

        admReqDetail_patient_name = (TextView) findViewById(R.id.admReqDetail_patient_name);
        admReqDetail_blood_group = (TextView) findViewById(R.id.admReqDetail_blood_group);
        btnCall = (Button) findViewById(R.id.admReqDetail_btnCall);
        ...
        admReqDetail_patient_name.setText(full_name);
        admReqDetail_blood_group.setText(blood_group);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(AdmReqDetail.this, AreaAdmin.class);
